  ...
  return (
    <div className=''>
      ...
      <div className="grid md:grid-cols-2 gap-x-6 gap-y-2 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row md:max-w-xl xs:w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 ">
