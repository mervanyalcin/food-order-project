...
interface ICategorySetFormProps {}
const CategorySetForm: React.FC<ICategorySetFormProps> = observer(() => {
  const {
  ...
  React.useEffect(() => {
    ...
    setValue("img", selectedCategory?.img);
  }, [selectedCategory]);
                ...
                >
                  ...
                  <div className="flex justify-end px-6 py-3 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600 ">
                    ...
                    <button
                      data-modal-hide="medium-modal"
                      type="button"
                      className="text-gray-500 bg-blue-500 hover:bg-blue-600  focus:outline-none rounded-lg text-sm font-medium px-5 py-2.5 dark:bg-blue-500 dark:text-white  dark:hover:text-white dark:hover:bg-blue-600"
                      onClick={() => {
                        initializeSelectedCategory();
                        setIsSetCategoryModalOpen();
                      }}
...
export default CategorySetForm;
